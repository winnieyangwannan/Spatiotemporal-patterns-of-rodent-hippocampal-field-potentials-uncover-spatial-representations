...
# load matlab data
run_obs = hdf5storage.loadmat('pyhsmm_data_ripple.mat')
...
fpa_hsmm = pyhsmm_spiketrains.models.PoissonHDPHMM(N=Nc, K_max=36)
...
plt.figure()
plt.imshow(spk_hsmm.rates[:spk_N_used_inf, :], interpolation="none", cmap="Greys", vmin=0, vmax=1)
...
hdf5storage.savemat('pyhsmm_data_ripple_result.mat',results)